...
describe('ReportService', () => {
  ...
  it('shoul retrieve reports from Api via GET', () => {
      const dummyData: any = [
        {
        assignTo: {azureUserId: '1234568', displayName: 'kotiba'},
      ...
      const request = httpMock.expectOne(`${service.URL}/allReports`);
 ...
 */
  it('shoul retrieve reports By id from Api via GET', () => {
    ...
    {
      assignTo: {azureUserId: '2121212', displayName: 'Hadi'},
      bytes: '/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAAEBAQEBAQEBAQEBAQ',
      campus: 'ELL',
      category: 'Netwerk',
      categoryDepartment: 'ICT diensten',
    ...
    service.getReport(Id).subscribe((res: Report) => {
      console.log(res);
 ...
 */
  ...
  service.getMyReports(reporterId).subscribe((res: Report[]) => {
    console.log(res);
    expect(res).toEqual(dummyData2[1]);
});

  const request = httpMock.expectOne(`${service.URL}/findByReporterId/${reporterId}`);
 ...
 */
  ...
  service.getAssignToMeReports().subscribe((res: Report[]) => {
    console.log(res);
    expect(res).toEqual(dummyData2[1]);
});
  const  userid = service.userid;
  const request = httpMock.expectOne(`${service.URL}/findByAssignToId/${userid}`);
