...
describe('ArchiveService', () => {
  ...
  it('should post the report to backend via POST', () => {
    ...
    const request = httpMock.expectOne(`${service.URL}/reportToArchive`, 'post to api');
  ...
  it('should post the order to backend via POST', () => {
    ...
    const request = httpMock.expectOne(`${service.URL}/orderToArchive`, 'post to api');
    expect(request.request.method).toBe('POST');
  ...
  it('shoul retrieve reports from Archive Api via GET', () => {
    ...
    const request = httpMock.expectOne(`${service.URL}/reportsFromArchive`);
