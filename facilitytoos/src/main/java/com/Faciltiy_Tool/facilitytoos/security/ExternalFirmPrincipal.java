...
public class ExternalFirmPrincipal implements OAuth2User, UserDetails {
    ...
    public static ExternalFirmPrincipal create(ExternalFirms externalFirms) {
        List<GrantedAuthority> authorities = Collections.
                singletonList(new SimpleGrantedAuthority("Role_externalFirm"));
        return new ExternalFirmPrincipal(
                externalFirms.getId(),
                externalFirms.getDisplayName(),
                externalFirms.getEmail(),
                authorities
                );
    }

    public static ExternalFirmPrincipal create(ExternalFirms externalFirms, Map<String, Object> attributes) {
